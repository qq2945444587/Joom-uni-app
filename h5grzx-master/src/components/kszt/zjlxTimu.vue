        ...
        <van-swipe-item v-for="(item, index) in subjectList" :key="index">
          <div class="topic_item">
            ...
            <div class="reply" v-if="item.questionType.id !== 5">
              <div
                v-if="
                  xuanTi.optionName !== '' && xuanTi.optionName !== undefined
                "
                class="tiBox"
              ...
              >
                <div class="choiceImg">
                  <img
                    v-if="
                      xuanTi.state === undefined &&
                      xuanTi.optionName !== '' &&
                      xuanTi.optionName !== undefined
                    "
                    :src="xuanTi.img"
                    alt
                  />
            ...
            <div
              class="answer_box"
              v-if="item.questionType.id !== 5 && comeFrom.comeFrom === '答案'"
            >
            ...
            <!-- 解析 -->
            <div class="analysis_box" v-if="comeFrom.comeFrom === '答案'">
